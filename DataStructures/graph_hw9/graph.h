...
namespace main_savitch_15
{
    ...
    public:
        ...
        std::size_t longest_distance(std::size_t source, std::size_t target) const;
        void dfs(std::vector<int>& dp, std::vector<bool>& visited, std::size_t source, std::size_t target) const;
    private:
